...
#zbior #b_kosz {
	background: url(img/bkoszyk.png);
	width: 114px;
	height: 26px;
	float: left;
	margin-left: 20px;
...
#k1z #lc {
	background: url(img/k_topcl.png);
	width: 2px;
	height: 29px;
	float: left;
}
...
#sumowanie_data #grafl {
	background: url(img/b_datal.png);
	width: 4px;
	height: 25px;
	margin-left: 10px;
	float: left;
...
#sumowanie_data #grafr {
	background: url(img/b_datar.png);
	width: 4px;
	height: 25px;
	float: left;
}
...
#sumowanie_data #grafc {
	background: url(img/b_datac.png);
	width: 140px;
	height: 25px;
	float: left;
}
		...
		<tr>
			...
			<td width="94" height="40">
				<div id="k3z">
					...
					<div id="cenan">
						<s:property value="priceNettoString" /> zł</div>
				</div>
			</td>
			<td width="65" height="40">
				<div id="k3z">
					<div id="ilosc">
						<s:property value="numberOfItem" />
						szt.
					</div>
				</div>
			</td>
...
<div id="sumowanie_zam">
	...
	<div id="sekright">
		<br>
		<s:property value="#session.order.paymentMethod" />
	</div>
	<!-- 	<div id="stopka"></div> -->
	<!-- 	<div id="sekleftn">Termin płatności:</div><div id="sekright">14 dni</div> -->
	<div id="stopka"></div>
	<div id="sekleftn">Data dostawy:</div>
	<div id="sekright">
		<fmt:formatDate pattern="dd-MM-yyyy"
			value="${session.order.deliveryDate}" />
	</div>
	<div id="stopka"></div>
</div>
<div id="stopka"></div>
...
<div id="sumowanie_info">Dodatkowe informacje:</div>
<div id="stopka"></div>
<div id="stopka"></div>
