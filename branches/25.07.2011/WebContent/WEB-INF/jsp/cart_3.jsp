...
<s:iterator value="#session.order.listOfProducts" status="item">
...
<div id="sumowanie_zam">
	...
	<div id="stopka"></div>
	<div id="sekleftn">netto:</div><div id="sekrightn"><s:property value="#session.order.totalPriceNettoString"/> zł</div>
	<div id="stopka"></div>
	<div id="sekleftn"><br>Forma płatności:</div><div id="sekright"><br><s:property value="#session.order.paymentMethod"/></div>
<!-- 	<div id="stopka"></div> -->
<!-- 	<div id="sekleftn">Termin płatności:</div><div id="sekright">14 dni</div> -->
	<div id="stopka"></div>
	<div id="sekleftn">Data dostawy:</div><div id="sekright"><fmt:formatDate pattern="dd-MM-yyyy" value="${session.order.deliveryDate}" /></div>
	<div id="stopka"></div>
	</div><div id="stopka"></div>
	
<div id="sumowanie_zam1">
	<div id="sekleft">Do zapłaty:</div><div id="sekright"><s:property value="#session.order.totalCostBrutto"/> zł</div>
	</div><div id="stopka"></div>

<!-- <div id="sumowanie_info">Dostawa:</div> -->
<!-- 		<div id="sumowanie_info1">Towar staramy się dostarczyć w ciągu 24h w dni robocze, jednak w szczególnych przypadkach towar może zostać dostarczony w ciągu 3dni roboczych. -->
<!-- 		<br>Za pomocą poniższego okna możesz określić dowolny termin otrzymania produktów (nie krótszy niż wskazany przez system i nie dłuższy niż 2-mce)</div> -->
<!-- 		<div id="stopka"></div> -->
<!-- <div id="sumowanie_data"> -->
<!-- 		<div id="tekst">Określ datę dostawy:</div> -->
<!-- 		<div id="grafl"></div> -->
<!-- 		<div id="grafc"></div> -->
<!-- 		<div id="grafr"></div> -->
<!-- 		<div id="data_dostawy">(dd-mm-rrrr)</div> -->
<!-- 		</div><div id="stopka"></div> -->

<div id="sumowanie_info">Dodatkowe informacje:</div><div id="stopka"></div>
		<div id="stopka"></div>
		<div id="sumowanie_info1">Przelewów bankowych prosimy dokonywać na poniższe konto bankowe w tytule podając swój indywidualny kod klienta:<br>
		<br><b>PL BPH o/Płock
		<br>80 1234 1234 12331 12313 12332</b><br>
		<br><br>* indywidualny kod klietna znajdą Państwo w sekcji "Twoje konto / Dane użytkownika"
		</div>


		<div id="stopka"></div>
		<div id="nawigacja1">
			<s:form theme="simple" action="ConfirmAllAction">	
				<s:submit id="zamawiam" name="next" value=""/>
