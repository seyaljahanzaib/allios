...
#main_message {
	background-color: #ccccff; width: 1150px; height: 50px; border-top: 1px dotted #9999cc; border-bottom: 1px dotted #9999cc; font: bold 12px/50px Tahoma; color: black; text-align: center; margin-bottom: 6px; 
	}
